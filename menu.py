...
class Menu(object):
    ...
    def runmenu(self,eve):
        ...
        self.menu.append(MenuItem(1,0,'P','AAASetup','eve.aaasetup()'))
        #self.menu.append(MenuItem(1,1,'P','Calibratcs','eve.calibratecs()'))
        self.menu.append(MenuItem(2,0,'P','Step Counter','mission_Step_Counter(eve)'))
        self.menu.append(MenuItem(2,1,'P','Row machine/tredmill','mission_Row_Machine(eve)'))
        self.menu.append(MenuItem(2,2,'P','Bench','mission_bench(eve)'))
